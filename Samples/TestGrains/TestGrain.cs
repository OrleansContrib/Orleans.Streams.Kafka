...
public class TestGrain : Grain<TestModel>, ITestGrain
{
	...
	public override async Task OnActivateAsync()
	{
		...
		var testStream = kafkaProvider.GetStream<TestModel>("streamId", "sucrose-test");
	...
	private static Task OnNextTestMessage(TestModel message, StreamSequenceToken sequenceToken)
	{
